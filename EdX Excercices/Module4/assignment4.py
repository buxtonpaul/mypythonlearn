...
def Plot3D(T, title, x, y,z, num_to_plot=40):
  ...
  ax.scatter(T[:,x],T[:,y],T[:,z], c='green', marker='.')
...
Plot2D(T, "PCA plot of face_data reduced to 2 dimensions", 0, 1, num_to_plot=40)
...
T=iso.transform(df)
Plot2D(T, "ISPMap plot of face_data reduced to 3 dimensions (plotting first 2)", 0, 1, num_to_plot=40)
Plot2D(T, "ISPMap plot of face_data reduced to 3 dimensions (plotting second 2)", 1, 2, num_to_plot=40)
...
Plot3D(T,"3d Plot of Isomapped data",0,1,2,num_to_plot=40)